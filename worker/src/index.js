...
cron.schedule('15 */2 * * * *', () => db2UpdateTable('product/pallet'));
cron.schedule('45 1-59/2 * * * *', () =>
...
cron.schedule('*/4 * * * *', () => db2UpdateTable('product/pack-destination'));
...
cron.schedule('*/4 * * * *', () => db2UpdateTable('product/pack-pallet-type'));
